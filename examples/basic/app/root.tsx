  ...
  return (
    <PressProvider config={config} sidebar={sidebar}>
      <ArdoLayout
          ...
          isHomePage ? undefined : (
            <Sidebar>
              <SidebarGroup title="Guide">
                ...
                <SidebarLink to="/guide/markdown-features">Markdown Features</SidebarLink>
              </SidebarGroup>
            </Sidebar>
          )
        }
        footer={
          <Footer
            message="<a href='https://github.com/sebastian-software/ardo/tree/main/examples/basic'>Ardo Basic Example</a> &middot; Built with <a href='https://github.com/sebastian-software/ardo'>Ardo</a>"
