...
export const Grid: Story = {
  ...
  render: () => (
    <ArdoCardGroup cols={3}>
      <ArdoCard title="Quick Start" icon="🚀" href="/guide/getting-started">
        Get up and running with an Ardo documentation site.
      </ArdoCard>
      <ArdoCard title="Configuration" icon="⚙️" href="/guide/configuration">
        Learn how to configure navigation, theme, and integrations.
      </ArdoCard>
      <ArdoCard title="Markdown" icon="📄" href="/guide/markdown">
