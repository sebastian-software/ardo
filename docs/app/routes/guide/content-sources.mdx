...
The [external content and collections reference](https://github.com/sebastian-software/ardo/tree/main/examples/content-sources) builds this complete shape: `project-content/recipes/` remains canonical, `/recipes/*` is generated, and a custom `/catalog` React route renders the same collection records.
