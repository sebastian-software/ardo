...
Already have a React repository? Use [Adopt Ardo in an Existing Project](/guide/adopt-ardo) instead. It gives a coding agent a safe, reference-project-based path without replacing your application setup.
