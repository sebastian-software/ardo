...
Every Ardo project ships with [Tailwind CSS v4](https://tailwindcss.com/) ready to use. It is there for the pieces that should move fast: custom landing pages, one-off examples, component demos, and MDX content that needs a little structure.

Ardo handles the framework UI with Vanilla Extract. Tailwind is for _your_ content, so you can style without leaving React or adding a second theme system.
