...
For example, define a shared prerequisite note in `app/snippets/prerequisites.mdx`:
...
Then import and render it from any MDX page:
...
Snippets can receive props in normal MDX expressions, compose Ardo components, and live alongside the rest of your application code. Because they are just MDX modules, Vite handles hot reloads and TypeScript-aware imports the same way as other route dependencies.
