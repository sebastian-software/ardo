...
It is a static documentation framework built on [React](https://react.dev/), [React Router 7](https://reactrouter.com/), and [Vite](https://vite.dev/). It gives React teams a simple docs workflow without a closed platform, a second UI framework, or a docs-only component model.
