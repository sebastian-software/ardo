...
Ardo's packages are released together with the same version so the framework, UI, runtime, and
scaffolding CLI stay aligned. See the package changelogs for release history:
[ardo](https://github.com/sebastian-software/ardo/blob/main/packages/ardo/CHANGELOG.md) and
[create-ardo](https://github.com/sebastian-software/ardo/blob/main/packages/create-ardo/CHANGELOG.md).

Ardo targets modern evergreen browsers supported by React 19 and Vite 8. The default theme uses
modern CSS such as OKLCH color and custom properties; teams with legacy browser requirements should
test their final docs build against their own support matrix.
