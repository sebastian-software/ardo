...
Reserves locale-prefixed canonical URLs for future localized docs. In 4.0 this is URL preparation
only: Ardo does not load translated content, resolve locale fallbacks, or render a public locale
switcher yet.
...
default locale is not hidden when i18n is active.
